...
🏦 از منوی اصلی می‌توانید به بخش‌های آموزشی، آزمون‌ها و آمادگی استخدامی دسترسی داشته باشید.
"""
    )
...
async def show_employment(query):
...
# =========================================================
# EMPLOYMENT BANK PAGE
# =========================================================

async def show_employment_bank(
    query,
    bank_key
):
    ...
    await query.edit_message_text(
        ...
        reply_markup=employment_bank_menu(bank_key)
    )


# =========================================================
# EMPLOYMENT BANK PLACEHOLDER
# =========================================================

async def employment_bank_section(
    query,
    bank_key,
    section_title
):
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                "🔙 صفحه بانک",
                callback_data=f"employment_{bank_key}"
            )
        ],
        [
            InlineKeyboardButton(
...
به‌صورت مرحله‌ای به ربات اضافه خواهد شد.
""",
        reply_markup=InlineKeyboardMarkup(keyboard)
    )
...
""",
    ...
    if data.startswith("employment_"):
        ...
        if bank_key in BANK_NAMES:

            await show_employment_bank(
                query,
                bank_key
            )
    ...
    # =====================================================
    # EMPLOYMENT BANK INTERNAL SECTIONS
    # =====================================================
    ...
    if data == "banking":
        ...
        await generic_message(
            ...
            "🏦 بانکداری",
            """
محتوای تخصصی بانکداری در حال توسعه است.

در این بخش قرار است موضوعاتی مانند:
...
"""
    ...
    if data == "exam":
        ...
        await generic_message(
            ...
            "🎓 آزمون و تست",
            """
آزمون‌های آموزشی اندیشکده مدیریت و بازار
...
بسته‌های آموزشی، جزوات و منابع آزمون در این بخش قرار خواهند گرفت.
"""
        )
